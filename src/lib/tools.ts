...
export const TOOLS: Tool[] = [
  ...
  {
    slug: "aws-fargate-vs-ec2-cost-calculator",
    title: "AWS Fargate vs EC2 Cost Calculator",
    description: "Compare Fargate vCPU/GB-hours vs EC2 instance-hours from your inputs.",
    category: "FinOps",
  },
  {
